var initialData = [1, 2, 3, 4, 5, 6, 10, 2, 2, 2, 2, 2, 2, 2], //initial items order (used if there is no saved data
...
html = kendo.render(template, data); //render the HTML with the data
